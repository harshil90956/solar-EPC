...
const THEMES = {
    ...
    deep: {
        ...
        vars: {
            ...
            '--solar': '#f97316',
            '--solar-light': '#fb923c',
            '--solar-glow': 'rgba(249,115,22,0.18)',
    ...
    slate: {
        ...
        vars: {
            ...
            '--border-muted': 'rgba(255,255,255,0.13)',
            '--border-active': 'rgba(37,99,235,0.52)',
            '--text-primary': '#f1f5f9',
            '--text-secondary': '#94a3b8',
            '--text-muted': '#64748b',
            '--text-faint': '#475569',
            ...
            '--solar': '#f59e0b',
            '--solar-light': '#fcd34d',
            '--solar-glow': 'rgba(245,158,11,0.16)',
            '--green': '#22c55e', '--green-bg': 'rgba(34,197,94,0.10)',
            '--red': '#ef4444', '--red-bg': 'rgba(239,68,68,0.10)',
            '--amber': '#f59e0b', '--amber-bg': 'rgba(245,158,11,0.12)',
            '--blue': '#3b82f6', '--blue-bg': 'rgba(59,130,246,0.10)',
    ...
    monochrome: {
        ...
        vars: {
            ...
            '--solar': '#ffffff',
            '--solar-light': '#e5e5e5',
            '--solar-glow': 'rgba(255,255,255,0.14)',
            '--green': '#aaaaaa', '--green-bg': 'rgba(170,170,170,0.10)',
            '--red': '#888888', '--red-bg': 'rgba(136,136,136,0.10)',
            '--amber': '#cccccc', '--amber-bg': 'rgba(204,204,204,0.10)',
            '--blue': '#dddddd', '--blue-bg': 'rgba(221,221,221,0.10)',
            '--cyan': '#bbbbbb', '--cyan-bg': 'rgba(187,187,187,0.10)',
            '--chart-grid': 'rgba(255,255,255,0.06)',
            '--tab-active-overlay': 'rgba(255,255,255,0.14)',
        },
    },
